...
<body class="image-sphere-style responsive">
 ...
 %></li>
			...
			<!-- END HEADER -->
			<div id="boxList">
				<form method="POST" action="/FridayTrip/AdminOk.do">
					<table id="tblForm">
						<tr>
							<th class="left">이상형</th>
							<td class="right"><input type="text" name="ideal" id="name" /></td>
						</tr>
						<tr>
							<th class="left">여행횟수</th>
							<td class="right"><input type="text" name="count" id="name" /></td>
						</tr>
						<tr>
							<th class="left">후기</th>
							<td class="right"><input type="text" name="etc" id="email" /></td>
						</tr>
					</table>
	...
	<input type="hidden" name="depth" value="${depth}" /> --%>
				...
				<input type="button" value="등록완료" onclick="send();" />
			</div>
			<!-- START COPYRIGHT -->
