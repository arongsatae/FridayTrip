	...
	<div class="h_right">
		...
		<div class="section gradient s-1 group">
			...
			<div id="box1">
				...
				<!-- 댓글 삭제 및 출력 start-->
				<!-- 폼 두번째 -->
				<form method="POST" id="form2" action="/FridayTrip/Trip/FreeCommentDel.do">
					<table id="comment">
					<c:set var="i" value="1" />
						...
						<tr>
							...
							<td id="comm4">
								<input type="text" name="delpw" id="delpw${i}" 
									style="width: 50px; margin: 0px 3px;" 
										value="암호입력" onfocus="this.value='';" />
							</td>
				...
				<!-- 댓글 삭제 end -->
					...
					<!-- 댓글쓰기 start -->
					<!-- 폼 세번째 -->
					<form action="/FridayTrip/Trip/FreeCommentOk.do" method="POST" id="form3" >
					<table id="comment2">
						<tr>
					...
					<div class="write">
						...
						<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트" 
							onclick="location.href='/FridayTrip/Trip/FreeList.do?page=${page}';" 
						...
						<c:if test="${!empty col}">
						<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트" 
							onclick="location.href='/FridayTrip/Trip/FreeList.do?col=${col}&word=${word}&${page}';" 
							style="cursor:pointer;" class="img1" />
						</c:if>
						<!-- 종료 -->
						
						<!-- 폼 네번째 -->
						<form action="/FridayTrip/Trip/FreeWrite.do" method="POST" id="img02">
						...
						<img src="/FridayTrip/Trip/images/002.JPG" alt="수정하기" style="cursor: pointer"
							onclick="location.href='/FridayTrip/Trip/FreeCheck.do?seq=${dto.seq}&page=${page}';"
							class="img1" /> 
						<img src="/FridayTrip/Trip/images/003.JPG" alt="삭제하기" style="cursor: pointer"
							onclick="location.href='/FridayTrip/Trip/FreeDel.do?seq=${dto.seq}';"
							class="img1" />
					</div>
				</div>
			</div>
