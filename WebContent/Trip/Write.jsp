	...
	<div class="h_right">
		...
		<div class="section gradient s-1 group">
			...
			<div id="box1">
				...
				<div id="box3">
					<form action="/FridayTrip/Trip/WriteOk.do" method="POST">
						<table id="tbl2">
							<tr>
								<th id="th1">이름</th>
							...
							<tr>
								<th id="th3">제목</th>
								<td><input type="text" class="td3" name="title" id="title" /></td>
							</tr>
							<tr>
								<th id="th4">내용</th>
							...
							<tr>
								...
								<tr>
					               <td id="th6">여행일수</td>
									<td>
				                    <input type="text" name="days" class="td6" name="days"/>
								    </td>
								</tr>
								<tr>
					               <td id="th7">여행시작날짜</td>
						...
						<input type="hidden" name="seq" value="${me.seq}" />
					...
					<div class="write">
					    ...
					    <img src="/FridayTrip/Trip/images/008.JPG" alt="쓰기완료" style="cursor: pointer"
