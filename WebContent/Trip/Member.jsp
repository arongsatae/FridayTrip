					...
					<c:forEach items="${list}" var="dto">
						<tr>
							...
							<td><input type="button" value="수정"
								onclick="location.href='/FridayTrip/Trip/MemberModify.do?seq=${dto.seq}';" /></td>
							<%-- <td><input type="button" value="설문조사결과" onclick="location.href='/FridayTrip/MemberModify.do?seq=${dto.seq}';"/></td> --%>
						</tr>
					</c:forEach>
				</table>
			</div>
