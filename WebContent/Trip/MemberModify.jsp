...
<body class="image-sphere-style responsive">
 ...
 %></li>
			...
			<!-- END HEADER -->
			<div id="boxList">
				<form method="post" action="/FridayTrip/Trip/MemberModifyOk.do">
					<table id="tblForm">
						<tr>
							<th>이름</th>
						...
						<tr>
							<th>레벨</th>
							<td><input type="text" name="lv" id="lv" value="${dto.lv}" /></td>
						</tr>
						<tr>
							<th>코인</th>
							<td><input type="text" name="coin" id="coin"
								value="${dto.coin}" /></td>
						</tr>
						<tr>
							<th>Before</th>
							<td><input type="text" name="before" id="before"
								value="${dto.before}" /></td>
						</tr>
						<tr>
							<th>After</th>

							<td><input type="text" name="after" id="after"
								value="${dto.after}" /></td>
				...
				<input type="button" id="submit" value="수정완료" onclick="send();" />
			</div>
			<!-- START COPYRIGHT -->
