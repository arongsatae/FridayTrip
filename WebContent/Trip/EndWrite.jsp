	...
	<div class="h_right">
		...
		<div class="section gradient s-1 group">
			...
			<div id="box1">
				...
				<div id="box3">
					<form action="/FridayTrip/Trip/EndWriteOk.do" method="POST">
						<table id="tbl2">
							<tr>
								<th id="th1">이름</th>
							...
							<tr>
								<th id="th5">장소</th>
								<td><input type="text" class="td3" name="travel" id="travel" /></td>
							</tr>							
							<tr>
								<th id="th3">제목</th>
					...
					<div class="write">
						<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트" style="cursor: pointer"
							onclick="location.href='/FridayTrip/Trip/EndList.do';" class="img1" />
