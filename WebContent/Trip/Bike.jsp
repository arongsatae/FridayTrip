		...
		<!-- start nav-->
			...
			<li style="border:0px;width:70px;">&nbsp;</li>
                ...
                <!-- START SLIDER -->
                 <div class="slider-wrapper theme-default">
                    ...
                    <div id="slider" class="nivo" style="height:350px">
                        <img src="/FridayTrip/Trip/images/trip/cycle03.jpg" width="960" height="350" alt="" /> 
                        <img src="/FridayTrip/Trip/images/trip/cycle01.jpg" width="960" height="350" alt="" /> 
                        <img src="/FridayTrip/Trip/images/trip/cycle02.jpg" width="960" height="350" alt="" /> 
                    </div>
                </div>
                <script type="text/javascript"> 
                    // edit here
                ...
                <div class="home-sections">
					...
					<div id="boxList${i}" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tBike&app=tAppBike';" style="cursor:pointer;" onmouseover="mouseover${i}();" onmouseout="mouseout${i}();"><!-- ?seq=${dto.seq} -->		
