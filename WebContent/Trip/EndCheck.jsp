...
<!-- //js경로 끝 -->
<style type="text/css">
#End { width: 300px; margin: 0px auto; padding: 20px; }
...
<div class="wrap">
	...
	<div class="h_right">
		...
		<form action="/FridayTrip/Trip/EndCheckOk.do" method="POST">
			<table id="tblpw">
				<tr>
					<td class="td1">암호</td>
		...
		<div class="write">
			...
			<img src="/FridayTrip/Trip/images/011.JPG" alt="확인완료" style="cursor: pointer" 
			onclick="send(${seq});" class="img1" />
		</div>
			<div id="one"></div>
		</div>
		<!-- 마지막 -->
