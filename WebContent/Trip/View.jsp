	...
	<div class="h_right">
		...
		<div class="section gradient s-1 group">
			...
			<div id="box1">
				...
				<!-- 댓글 삭제 및 출력 start-->
				<!-- 폼 두번째 -->
				<form method="POST" id="form2" action="/FridayTrip/Trip/CommentDel.do">
					<table id="comment">
					<c:set var="i" value="1" />
				...
				<!-- 댓글 삭제 end -->
					...
					<!-- 댓글쓰기 start -->
					<!-- 폼 세번째 -->
					<form action="/FridayTrip/Trip/CommentOk.do" method="POST" id="form3" >
					<table id="comment2">
						<tr>
					...
					<div class="write">
						...
						<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트" 
							onclick="location.href='/FridayTrip/Trip/List.do?page=${page}';" 
						...
						<c:if test="${!empty col}">
						<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트" 
							onclick="location.href='/FridayTrip/Trip/List.do?col=${col}&word=${word}&${page}';" 
							style="cursor:pointer;" class="img1" />
						</c:if>
						<!-- 종료 -->
						
						<!-- 폼 네번째 -->
						<form action="/FridayTrip/Trip/Write.do" method="POST" id="img02">
						...
						<img src="/FridayTrip/Trip/images/002.JPG" alt="수정하기" style="cursor: pointer"
							onclick="location.href='/FridayTrip/Trip/Check.do?seq=${dto.seq}';"
							class="img1" /> 
						<img src="/FridayTrip/Trip/images/003.JPG" alt="삭제하기" style="cursor: pointer"
							onclick="location.href='/FridayTrip/Trip/Del.do?seq=${dto.seq}';"
							class="img1" />
					</div>
				</div>
			</div>
