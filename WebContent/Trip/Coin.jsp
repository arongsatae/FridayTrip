...
<style type="text/css">
	  	...
	  	#tblbox { width: 400px;  text-align: center; margin: 5px auto; margin-left: 270px; font-size: 13px; margin-top: 30px; }
		...
		#tblbox tr td:nth-child(3)  {width: 100px; text-align: center; }
		#cc {font-size: 13px; color:#4f4f4f; font-weight: bold; margin-left: 530px; margin-top: -20px; }
		#coinuse { margin:0px; margin-top: 80px; margin-left: 100px; }
		#coinusebt { margin:0px; margin-top: -20px; margin-left: 505px; }
	...
	<div class="h_right">
		...
		<!-- start nav-->
			...
			<li style="border:0px;width:70px;">&nbsp;</li>
                ...
                <!-- END HEADER -->        
				<img src="/FridayTrip/Trip/images/coinuse.png" id="coinuse" />
       					<table id="tblbox">
        					...
        					<tr>
        						...
        						<td><%=  list.get(i).getCoin() %> 원</td>
        						<td><%=  list.get(i).getCoin() %> Coin</td>
        					...
        					<input type="button" value="코인 사용 내역 보러가기" id="coinusebt" onclick="location.href='/FridayTrip/Trip/Coinre.jsp'"/><br /><br /><br /><br />
