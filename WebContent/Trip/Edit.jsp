	...
	<div class="h_right">
		...
		<div class="section gradient s-1 group">
			...
			<div id="box1">
				...
				<div id="box3">
					<form action="/FridayTrip/Trip/EditOk.do" method="POST">
						<table id="tbl2">
							<tr>
								<th id="th1">이름</th>
								<td><input type="text" class="td1" name="name"
									value="${me.name}" style="border: 0px;" disabled="disabled" /></td>
							</tr>
							<tr>
								<th id="th2">암호</th>
								<td><input type="password" class="td2" name="pw" id="pw" /></td>
							</tr>
							<tr>
								<th id="th3">제목</th>
								<td><input type="text" class="td3" name="title" id="title" value="${dto.title}" /></td>
							</tr>
							<tr>
								<th id="th4">내용</th>
								<td><textarea rows="25" cols="60" class="td4" id="content"
										name="content">${dto.content}</textarea></td>
							</tr>
							<tr>
								<th id="th5">총인원수</th>
								<td><input type="text" class="td5" id="total"
										name="total" value="${dto.total}"></td>
							</tr>
								<tr>
					               <td id="th6">여행일수</td>
									<td>
				                    <input type="text" name="days" class="td6" name="days" value="${dto.days}"/>
								    </td>
								</tr>
								<tr>
					               <td id="th7">여행시작날짜</td>
									<td>
				                    <input type="text" name="starts" value="YYYY-MM-DD" value="${dto.starts}"/>
								    </td>
								</tr>
						</table>
					...
					<div class="write">
						<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트" style="cursor: pointer"
							onclick="location.href='/FridayTrip/Trip/List.do';" class="img1" />
