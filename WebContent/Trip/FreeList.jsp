...
<body class="home image-sphere-style responsive">
 ...
 %></li>
			...
			<div class="section gradient s-1 group">
				<div id="free">
					<img src="/FridayTrip/Trip/images/bd01.png" alt="자유게시판" />
				</div>
								...
								<tr>
									...
									<td style="text-align: left; margin-left: 5px;">
										<!-- 검색중일땐 검색 상황을 view 에게 넘겼다가 다시 되돌려 받을것 --> <c:if
											test="${empty search}">
										${dto.depthSpan}<a
												href="/FridayTrip/Trip/FreeView.do?seq=${dto.seq}&page=${nowPage}">
												${dto.title}</a>
						...
						<div id="total">
							<div class="write">
								<img src="/FridayTrip/Trip/images/004.JPG" alt="리스트"
									...
									onclick="location.href='/FridayTrip/Trip/FreeList.do';"
									class="img1" id="img01" />

								<form action="/FridayTrip/Trip/FreeWrite.do" method="POST"
									id="img02">
							...
							<div id="sch">
								<form action="/FridayTrip/Trip/FreeList.do" method="GET">
