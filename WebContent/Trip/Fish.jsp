		...
		<!-- start nav-->
			...
			<li style="border:0px;width:70px;">&nbsp;</li>
                ...
                <!-- START SLIDER -->
                 <div class="slider-wrapper theme-default">
                    ...
                    <div id="slider" class="nivo" style="height:350px">
                        <img src="/FridayTrip/Trip/images/trip/fishsl01.jpg" width="960" height="350" alt="" /> 
                        <img src="/FridayTrip/Trip/images/trip/fishsl02.jpg" width="960" height="350" alt="" /> 
                        <img src="/FridayTrip/Trip/images/trip/fishsl03.jpg" width="960" height="350" alt="" /> 
                    </div>
                </div>
                <script type="text/javascript"> 
                    // edit here
                ...
                <div class="home-sections">
					...
					<div id="boxList${i}" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tFish&app=tAppFish';" style="cursor:pointer;" onmouseover="mouseover${i}();" onmouseout="mouseout${i}();"><!-- ?seq=${dto.seq} -->		
