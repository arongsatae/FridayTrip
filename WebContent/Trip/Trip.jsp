		...
		<!-- start nav-->
			...
			<li style="border:0px;width:70px;">&nbsp;</li>
                ...
                <!-- START SLIDER -->
                 <div class="slider-wrapper theme-default">
                    ...
                    <div id="slider" class="nivo" style="height:350px">
                        <img src="/FridayTrip/Trip/images/trip/tripmain01.jpg" width="960" height="350" alt="" /> 
                        <img src="/FridayTrip/Trip/images/trip/tripmain02.jpg" width="960" height="350" alt="" /> 
                        <img src="/FridayTrip/Trip/images/trip/tripmain03.jpg" width="960" height="350" alt="" /> 
                    </div>
                </div>
                <script type="text/javascript"> 
                    // edit here
                ...
                <div class="home-sections">
					...
					<div id="boxList1" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tBike&app=tAppBike';" style="cursor:pointer;" onmouseover="mouseover1();" onmouseout="mouseout1();">	
					...
					<div id="boxList2" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tFish&app=tAppFish';" style="cursor:pointer;" onmouseover="mouseover2();" onmouseout="mouseout2();">		
					<div id="imgList2" ><img src="/FridayTrip/Trip/images/trip/${dto.img}" /></div>
						<span class="name">${dto.name}</span><br/>
						<strong class="price">가격</strong><span class="coin">　${dto.coin} 원</span><br />
						<span class="subcontent">${dto.subcontent}</span>	
					</div>
					...
					<div id="boxList3" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tFood&app=tAppFood';" style="cursor:pointer;" onmouseover="mouseover3();" onmouseout="mouseout3();"><!-- ?seq=${dto.seq} -->		
					<div id="imgList3" ><img src="/FridayTrip/Trip/images/trip/${dto.img}" /></div>
						<span class="name">${dto.name}</span><br/>
						<strong class="price">가격</strong><span class="coin">　${dto.coin} 원</span><br />
						<span class="subcontent">${dto.subcontent}</span>	
					</div>
					...
					<div id="boxList4" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tLocal&app=tAppLocal';" style="cursor:pointer;" onmouseover="mouseover4();" onmouseout="mouseout4();"><!-- ?seq=${dto.seq} -->		
					<div id="imgList4" ><img src="/FridayTrip/Trip/images/trip/${dto.img}" /></div>
						<span class="name">${dto.name}</span><br/>
						<strong class="price">가격</strong><span class="coin">　${dto.coin} 원</span><br />
						<span class="subcontent">${dto.subcontent}</span>	
					</div>
					...
					<div id="boxList5" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tMt&app=tAppMt';" style="cursor:pointer;" onmouseover="mouseover5();" onmouseout="mouseout5();"><!-- ?seq=${dto.seq} -->		
					<div id="imgList5" ><img src="/FridayTrip/Trip/images/trip/${dto.img}" /></div>
						<span class="name">${dto.name}</span><br/>
						<strong class="price">가격</strong><span class="coin">　${dto.coin} 원</span><br />
						<span class="subcontent">${dto.subcontent}</span>	
					</div>
					...
					<div id="boxList6" class="boxList" onclick="location.href='/FridayTrip/Trip/Detail.do?seq=${dto.seq}&table=tBike&app=tAppBike';" style="cursor:pointer;" onmouseover="mouseover6();" onmouseout="mouseout6();"><!-- ?seq=${dto.seq} -->		
					<div id="imgList6" ><img src="/FridayTrip/Trip/images/trip/${dto.img}" /></div>
						<span class="name">${dto.name}</span><br/>
						<strong class="price">가격</strong><span class="coin">　${dto.coin} 원</span><br />
						<span class="subcontent">${dto.subcontent}</span>	
					</div>
