...
<title>Insert title here</title>
 ...
 <link rel="stylesheet" type="text/css" media="all" href="style.css" />
      ...
      <style type="text/css">
	  	...
	  	#ppsearch { position:absolute; left:180px; top:600px; z-index: 22; } 
</style>
...
<form method="post" action="/FridayTrip/Trip/pwcheck.jsp">


<span style="margin-left: 30px"> 이름을 입력해주세요 <br> <input style="margin-left: 37px" type="text" name="name" size= 6 > <br></span>
   
<span style="margin-left: 30px"> 아이디를 입력해주세요 <br> <input style="margin-left: 37px" type="text" name="id" size= 6 > <input type="submit" value="찾기"></span>
