...
<body class="image-sphere-style responsive">
 ...
 %></li>
			...
			<div class="home-sections">
				...
				<img src="/FridayTrip/Trip/images/trip/back.JPG" alt="결제하기"
					onclick="location.href='/FridayTrip/Trip/Index.do'" onmouseover="mouseover();" onmouseout="mouseout();" id="application"
