...
public class TripBicycleAddOk extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		TripBicycleDTO dto = new TripBicycleDTO();
		dto.setSeq(seq);
		dto.setPseq(pseq);
		dto.setName(name);
     ...
     dto.setCount(count);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/Trip/TripBicycleAddOk.jsp");
